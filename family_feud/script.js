...
jsonFile:"FF_HW_10_31_2024.json",
  ...
  makeQuestion: function(qNum){
    ...
    function showCard(){
      ...
      app.getBoardScore()
      var audio = new Audio('sounds/audio7.wav');
      audio.play();
    }
...
function playStrike1() {
  var strike = new Audio('/sounds/audio6.wav');
  strike.play();
}
app.init()
...
// old json
// "Name something in Mr. C's and Mr. Meade's Classroom(s)": [["Rubber Duck/Chicken",25],["Computers",21],["Mr. C", 17],["Mr. Meade", 16],["Students", 2]]
//"Name a word people often mispronounce":[["Worchestershire Sauce",10],["Pneumonoultramicroscopicsilicovolcanoconiosis",6],["Costantino",5],["Supercalifragilisticexpialidocious",2]]
//"In Horror Movies, Name a Place Teenagers Go Where There’s Always a Killer On the Loose":[["Basement",11],["Woods/Forest",10],["House/Abandoned House",9],["Camp/Campsite",7],["Party",5],["Cabin",4],["Graveyard",3],["School",2]],